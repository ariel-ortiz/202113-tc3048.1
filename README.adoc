...
This project contains all the source files that the course instructor will be writing in class during the 2021 August-December semester.
...
2. Clone this repository. Type at the terminal:
    ...
    git clone https://github.com/ariel-ortiz/202113-tc3048.1.git tc3048
